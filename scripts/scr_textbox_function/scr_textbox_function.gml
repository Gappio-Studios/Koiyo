...
// sets bottom of screen requirements for custom function
/// @param text
/// @param [character]
/// @param [side]
function scr_text(_text){
		...
		if argument_count > 1 {
			switch(argument[1])
				...
				//-----------------BLONDE YOUEE
				case	"Youee Blonde":
					speaker_sprite[page_number] = spr_youee_talk_blonde;
					txtb_spr[page_number] = spr_textbox_blonde;
					snd[page_number] = snd_generic_1;
					break;
				case	"Youee Blonde Angry":
					speaker_sprite[page_number] = spr_youee_talk_blonde_angry;
					txtb_spr[page_number] = spr_textbox_blonde;
					snd[page_number] = snd_generic_1;
					break;
				//----------------REGULAR YOUEE
				case	"Youee Default":
					speaker_sprite[page_number] = spr_youee_talk;
					txtb_spr[page_number] = spr_textbox_default_youee;
					snd[page_number] = snd_generic_hostile_1;
					break;
				}
			}
